...
OCC_TABS = [
    ...
    {"key": "tellz", "icon": "tellz.png", "name": "TellZ", "emoji": "🗣️", "needs": TIER_PREMIUM,
     ...
     "builds": "tellz"},
    {"key": "logz", "open_in": "logz", "icon": "logz.png", "name": "LogZ", "emoji": "🪵", "needs": TIER_FREE,
     "desc": "What was DONE, by day, week, month or a range you pick. Free sees the last 30 days.",
     "builds": "logz"},
